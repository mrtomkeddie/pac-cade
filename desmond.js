...
module.exports = localforage_js;
      ...
      shadow.innerHTML=`<style>#player{position:absolute;inset:0;display:flex;flex-direction:column;align-items:center;justify-content:center;gap:6px;background:#000}canvas{display:block;image-rendering:pixelated}</style><div id="player">
        <canvas id="top" width="256" height="192"></canvas>
        <canvas id="bottom" width="256" height="192"></canvas>`;
      function sizeCanvases(){
        try{
          var r = player.getBoundingClientRect();
          var w = Math.floor(Math.min(r.width, r.height / 1.5));
          var h = Math.floor(w * 192 / 256);
          var t = shadow.getElementById('top');
          var b = shadow.getElementById('bottom');
          t.style.width = w + 'px';
          t.style.height = h + 'px';
          b.style.width = w + 'px';
          b.style.height = h + 'px';
