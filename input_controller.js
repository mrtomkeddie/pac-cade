...
class InputController {
    ...
    defaultKeymappings() {
        return {
            ...
            Mapping_Action_CUP: 'ArrowUp',
            Mapping_Action_CDOWN: 'e',
            Mapping_Action_CLEFT: 'ArrowLeft',
            Mapping_Action_CRIGHT: 'ArrowRight',
            Mapping_Action_Analog_Up: 'ArrowUp',
            Mapping_Action_Analog_Down: 'ArrowDown',
            Mapping_Action_Analog_Left: 'a',
            Mapping_Action_Analog_Right: 'd',
            Mapping_Action_Z: 'ShiftLeft',
            Mapping_Action_L: 'q',
            Mapping_Action_R: 'r',
            Mapping_Menu: '`',
            Joy_Mapping_Left: 14,
    ...
    keyDown(event) {
        ...
        try {
            const now = Date.now();
            if (input_controller.lastKeyTimes[k] && (now - input_controller.lastKeyTimes[k]) < input_controller.keyDebounceMs) return;
            input_controller.lastKeyTimes[k] = now;
        } catch {}
        ...
        let key = event.key;
        if ((event.code === 'Space') || key === 'Spacebar' || key === 'Space') key = ' ';
        let arrowkey = false;

        //player 1
        if (key == input_controller.KeyMappings.Mapping_Down) {
            input_controller.Key_Down = true;
            arrowkey = true;
        }
        if (key == input_controller.KeyMappings.Mapping_Up) {
            input_controller.Key_Up = true;
            arrowkey = true;
        }
        if (key == input_controller.KeyMappings.Mapping_Left) {
            input_controller.Key_Left = true;
            arrowkey = true;
        }
        if (key == input_controller.KeyMappings.Mapping_Right) {
            input_controller.Key_Right = true;
            arrowkey = true;
        }
        if (key == input_controller.KeyMappings.Mapping_Action_Start) {
            input_controller.Key_Action_Start = true;
        }
        if (key == input_controller.KeyMappings.Mapping_Action_CUP) {
            input_controller.Key_Action_CUP = true;
        }
        if (key == input_controller.KeyMappings.Mapping_Action_CDOWN) {
            input_controller.Key_Action_CDOWN = true;
        }
        if (key == input_controller.KeyMappings.Mapping_Action_CLEFT) {
            input_controller.Key_Action_CLEFT = true;
        }
        if (key == input_controller.KeyMappings.Mapping_Action_CRIGHT) {
            input_controller.Key_Action_CRIGHT = true;
        }
        if (key == input_controller.KeyMappings.Mapping_Action_B) {
            input_controller.Key_Action_B = true;
        }
        if (input_controller.KeyMappings.Mapping_Action_Z === 'ShiftLeft') {
            if (event.code === 'ShiftLeft' || (event.key === 'Shift' && event.location === 1)) input_controller.Key_Action_Z = true;
        } else {
            if (key == input_controller.KeyMappings.Mapping_Action_Z) input_controller.Key_Action_Z = true;
        }
        if (key == input_controller.KeyMappings.Mapping_Action_L) {
            input_controller.Key_Action_L = true;
        }
        if (key == input_controller.KeyMappings.Mapping_Action_R) {
            input_controller.Key_Action_R = true;
        }
        if (key == input_controller.KeyMappings.Mapping_Action_A) {
            input_controller.Key_Action_A = true;
        }
        if (key == input_controller.KeyMappings.Mapping_Menu) {
    ...
    keyUp(event) {
        ...
        if (input_controller.KeyMappings.Mapping_Action_Z === 'ShiftLeft') {
            if (event.code === 'ShiftLeft' || (event.key === 'Shift' && event.location === 1)) input_controller.Key_Action_Z = false;
        } else {
            if (key == input_controller.KeyMappings.Mapping_Action_Z) input_controller.Key_Action_Z = false;
        }
        if (key == input_controller.KeyMappings.Mapping_Action_L) {
